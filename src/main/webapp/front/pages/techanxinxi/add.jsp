			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.techanmingcheng" type="text" name="techanmingcheng" id="techanmingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">特产分类</label>
                        <div class="layui-input-block">
                            <select name="techanfenlei" id="techanfenlei" lay-filter="techanfenlei">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in techanfenlei" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="chandi" id="chandi" lay-filter="chandi">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in chandi" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                                                                            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.price" type="text" name="price" id="price" autocomplete="off" class="layui-input">
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">特产详情：</label>
						<div class="layui-input-block">
							<textarea name="techanxiangqing" id="techanxiangqing">请输入特产详情</textarea>
						</div>
					</div>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/techanfenlei/techanfenlei`,'get',{},(res)=>{
					vue.techanfenlei = res.data
				});
																// 上传图片
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																																...
																																http.request(`option/chandi/chandi`,'get',{},(res)=>{
					vue.chandi = res.data
				});
												                var edit = tinymce.render({
                    elem: "#techanxiangqing",
                    height: 600,
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var techanxiangqing = tinymce.get('#techanxiangqing').getContent()
					data.techanxiangqing = techanxiangqing;
					...
					// 提交数据
					http.requestJson('techanxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
