...
<body>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in techanxinxiRecommend" v-bind:key="index">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`techanxinxi/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.techanxinxiRecommend = res.data.list;
      });
